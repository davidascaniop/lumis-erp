...
export default function RecepcionesPage() {
  return (
    <div className="p-6 space-y-6 page-enter">
      <div>
        <h1 className="text-3xl font-heading font-bold text-text-1">Recepción de Mercancía</h1>
        <p className="text-text-2 mt-1">Gestión de ingresos y entradas de almacén.</p>
      </div>
      ...
      <Card className="p-12 border-dashed flex flex-col items-center justify-center bg-surface-card/50">
        ...
        <p className="text-text-3 text-center max-w-sm">
          Estamos preparando este módulo para que puedas gestionar tus recepciones de forma automatizada.
        </p>
      </Card>
    </div>
  );
