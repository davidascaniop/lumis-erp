...
import { 
  ...
  DollarSign, Clock, Users, Loader2, ArrowRight
} from "lucide-react";
import { 
  ...
  return (
    <div className="h-full flex flex-col pt-6 px-6 animate-fade-in bg-gray-50/30">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-text-3 font-outfit">
          Branding Activo: <span className="text-brand font-bold">{businessName}</span>
        </p>
      </div>
