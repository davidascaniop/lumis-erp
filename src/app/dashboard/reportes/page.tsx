    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Button
            variant="outline"
            className="border-[#E040FB]/15 text-[#B8A0D0] hover:bg-[#E040FB]/5 hover:text-[#F5EEFF] cursor-pointer"
          >
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(to bottom left, ${card.color}, transparent)`,
                }}
              />
              ...
              <div className="relative z-10">
                <p className="text-sm font-medium text-[#B8A0D0] mb-1">
                  {card.title}
                </p>
                <p className="text-3xl font-bold text-[#F5EEFF]">
                  {card.value}
                </p>
              </div>
            </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-[#6B5280] text-sm">
                Rendimiento de ventas por día
              </p>
            </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Legend
                  ...
                  height={36}
                  iconType="circle"
                  wrapperStyle={{ fontSize: "12px", color: "#B8A0D0" }}
                />
              </PieChart>
            </ResponsiveContainer>
          </div>
