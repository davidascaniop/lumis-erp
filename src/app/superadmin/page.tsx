    ...
    <div className="space-y-6 page-enter pb-10">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          {/* FILA 2: OPERACIONES (5 CARDS PEQUEÑAS) */}
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
             ...
             <Link href="/superadmin/clientes/suscripciones?filter=vencidos" className="bg-[#FFF5F7] border border-[#FFE4E8] rounded-2xl p-4 shadow-sm hover:bg-[#FFEBF0] transition-all group relative overflow-hidden cursor-pointer">
