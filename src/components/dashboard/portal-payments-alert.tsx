...
export function PortalPaymentsAlert({ companyId }: { companyId: string }) {
  ...
  return (
    <div
      className="relative bg-gradient-to-r from-[rgba(224,64,251,0.12)] to-[rgba(124,77,255,0.08)]
                        border border-[rgba(224,64,251,0.30)] rounded-2xl p-5 mb-4
                        shadow-[0_0_32px_rgba(224,64,251,0.12)]"
    >
      {/* Ping */}
      <div className="absolute -top-1.5 -right-1.5">
        <span className="relative flex h-4 w-4">
          ...
          <span
            className="relative inline-flex rounded-full h-4 w-4 bg-[#E040FB]
      ...
      <div className="flex items-start gap-4">
        {/* Ícono */}
        <div
          className="w-10 h-10 rounded-xl bg-[rgba(224,64,251,0.15)]
                                border border-[rgba(224,64,251,0.25)]
                                flex items-center justify-center flex-shrink-0"
        >
          <ShieldCheck className="w-5 h-5 text-[#E040FB]" />
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-[#9585B8] mb-3 leading-relaxed">
            {latest.content}
          </p>

          {/* Preview */}
          {meta.amount && (
            <div className="flex items-center gap-4 mb-3 p-3 rounded-xl bg-black/20">
              <div>
                <p className="text-[10px] text-[#4A3A6A] uppercase tracking-wider">
                  Monto
                </p>
                <p className="font-mono text-sm font-bold text-[#00E5CC]">
              ...
              <div>
                ...
                <p className="font-mono text-xs text-white">{meta.reference}</p>
              </div>
              {meta.proof_url && (
                <a
                  href={meta.proof_url}
                  ...
                  className="flex items-center gap-1 text-[11px] text-[#E040FB] font-semibold hover:underline ml-auto"
                >
        ...
        <button
          ...
          className="p-1.5 rounded-lg hover:bg-white/[0.08] text-[#9585B8] hover:text-white transition-colors flex-shrink-0"
        >
          <X className="w-4 h-4" />
        </button>
      </div>
