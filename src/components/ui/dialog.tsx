...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1.5 text-text-3 hover:text-text-1 hover:bg-surface-hover/10 transition-colors outline-none disabled:pointer-events-none">
        <X className="h-4 w-4" />
