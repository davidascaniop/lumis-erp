  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          <View style={styles.headerInfoRow}>
            <Text style={styles.headerLabel}>N° Cotiza:</Text>
            <Text style={styles.headerValue}>{quote.quote_number}</Text>
          </View>
          <View style={styles.headerInfoRow}>
          ...
          <View style={styles.headerInfoRow}>
            <Text style={styles.headerLabel}>Vence:</Text>
            <Text style={styles.headerValue}>
      ...
      <Text style={styles.footer} fixed>
        Este presupuesto es válido hasta la fecha de vencimiento indicada. LUMIS ERP/CRM.
      </Text>
    </Page>
  </Document>
);
